...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "GE_LISTADO_RESOLUCIONES" ("RES_ID", "F_CREACION", "F_MODIFICACION", "USU_CREACION", "USU_MODIFICACION", "T_CODIGO_RESOL", "F_FECHA_RESOLUCION", "TIP_RESOL_ID", "TIPO_RESOL", "SENTIDO_ID", "SENTIDO_RESOL", "PER_ID", "NOMBRE_PERSONA", "NIF_PERSONA", "COD_TIPO_PERSONA", "SUJ_ID", "NOMBRE_SUJ_OBLIGADO", "NIF_SUJ_OBLIGADO", "F_FECHA_PUBLI_WEB", "L_ANONIMIZADA", "L_NOTIFICADA_TOTAL") AS 
  SELECT 
    R.RES_ID, 
	...
	R.F_FECHA_PUBLI_WEB AS F_FECHA_PUBLI_WEB,
	R.L_ANONIMIZADA AS L_ANONIMIZADA,
	R.L_NOTIFICADA_TOTAL AS L_NOTIFICADA_TOTAL
...
-- -------------------------------------
  ...
  SELECT 
	...
	persona.t_nif_cif as T_IDENT_PERSONA,
...
-- -------------------------------
 ...
 CREATE OR REPLACE VIEW "GE_TRAMITES_ABIERTOS" AS 
  SELECT
	...
	vista_exped.T_IDENT_PERSONA AS T_IDENT_PERSONA,
