...
INSERT INTO FOR_PRUEBAS (PRU_ID, F_CREACION, USU_CREACION, C_CODIGO, D_DESCRIPCION, N_VERSION) VALUES (S_PRUEBAS.NEXTVAL, SYSDATE, (SELECT USER FROM DUAL), 'PRU1', 'Prueba 1', 1);
INSERT INTO FOR_PRUEBAS (PRU_ID, F_CREACION, USU_CREACION, C_CODIGO, D_DESCRIPCION, N_VERSION) VALUES (S_PRUEBAS.NEXTVAL, SYSDATE, (SELECT USER FROM DUAL), 'PRU2', 'Prueba 2', 1);
INSERT INTO FOR_PRUEBAS (PRU_ID, F_CREACION, USU_CREACION, C_CODIGO, D_DESCRIPCION, N_VERSION) VALUES (S_PRUEBAS.NEXTVAL, SYSDATE, (SELECT USER FROM DUAL), 'PRU3', 'Prueba 3', 1);
