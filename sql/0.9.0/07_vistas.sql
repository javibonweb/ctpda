...
-------------------
 ...
 CREATE OR REPLACE FORCE VIEW GE_EXP_PEREXP_SUJEXP (EXP_ID, F_CREACION, F_MODIFICACION, USU_CREACION, USU_MODIFICACION, F_FECHA_REGISTRO, T_TIP_EXP, T_NUM_EXPEDIENTE, T_SITUACION, T_FECHA_ENTRADA, T_PERSONA, T_SUJETO_OBLIGADO, T_NOMBRE_EXPEDIENTE, ID_MATERIA, ID_MATERIASUP) AS 
 SELECT 
