...
INSERT INTO GESTOR.GE_PERMISOS (PER_ID, F_CREACION, USU_CREACION, L_ACTIVA, C_CODIGO, D_DESCRIPCION, N_VERSION) VALUES (GESTOR.S_PERMISOS.NEXTVAL,SYSDATE,  (SELECT TIP_TRA_ID FROM GESTOR.GE_TIPO_TRAMITE gtt WHERE T_CODIGO = 'ERR'), 1, 'TRAMITE_GRS', 'Permisos para tramites Gonzalo Rando Serna', 1);
INSERT INTO GESTOR.GE_PERMISOS_PERFILES (PERM_PERF_ID, F_CREACION, USU_CREACION, L_ACTIVA, N_VERSION, PERMPERF_PERF_ID, PERMPERF_PERM_ID) VALUES (GESTOR.S_PERMISOS_PERFILES.NEXTVAL,SYSDATE,  (SELECT TIP_TRA_ID FROM GESTOR.GE_TIPO_TRAMITE gtt WHERE T_CODIGO = 'ERR'), 1, 1,(SELECT PER_ID FROM GESTOR.GE_PERFILES gp WHERE C_CODIGO = 'ADMIN'), (SELECT PER_ID FROM GESTOR.GE_PERMISOS gp WHERE C_CODIGO = 'TRAMITE_GRS'));
