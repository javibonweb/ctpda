...
@NoArgsConstructor
@AllArgsConstructor
public class EditorConfig implements Serializable{  // the parameters pertaining to the editor interface: opening mode (viewer or editor), interface language, additional buttons, etc.
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	
	private transient HashMap<String, Object> actionLink = null;  // the data which contains the information about the action in the document that will be scrolled to
    ...
    private String mode;  // the editor opening mode
    @Autowired
