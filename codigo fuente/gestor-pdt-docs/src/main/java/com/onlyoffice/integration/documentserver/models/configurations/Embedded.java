...
@Getter
@Setter
public class Embedded implements Serializable{  // the parameters which allow to change the settings which define the behavior of the buttons in the embedded mode
    /**
	 * 
	 */
