...
public class MenuBean extends BaseBean implements Serializable {
	...
	private enum Items {
		NULO, MATERIAS, PARAMETROS, MOTIVOSRELACION, DOMINIOS, PERSONAS, TIPOSAGRUPACIONES, SUJETOSOBLIGADOS,
		EXPEDIENTES;
	}
	...
	public void init() {
		...
		/**
		 * MONTAMOS EL MENU EN FUNCION DE LOS PERMISOS ASOCIADOS AL PERFIL DEL USUARIO
		...
		submenuForVictor.setLabel(mensajesProperties.getString("formacion.vdc"));
	...
	public void cambiarPerfil() {
		...
		this.listaPerfilesAsociados = perfilService.findPerfilesActivosAsociadosUsuario(
				((Usuario) JsfUtils.getSessionAttribute(Constantes.USUARIO)).getId());
