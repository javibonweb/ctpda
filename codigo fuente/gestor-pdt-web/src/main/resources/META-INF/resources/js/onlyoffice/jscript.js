...
if (typeof jQuery !== "undefined") {
    ...
    /*var onloadScripts = function () {
        ...
        function getOnlyOfficeCookie(name) {
        ...
        function setOnlyOfficeCookie(name, value) {
            document.cookie = name + "=" + value + "; path=/gestor-pdt ; expires=" + new Date(Date.now() + 1000 * 60 * 60 * 24 * 7).toUTCString(); //week
        }

        //var userId = getOnlyOfficeCookie("uid");
        var langId = getOnlyOfficeCookie("ulang");

        /*if(!userId){
            //jq(document).on("ready",function(){
            jq(document).ready(function(){
                setOnlyOfficeCookie("uid",)
            })
        }*/
        if(!langId){
            //jq(document).on("ready",function(){
            jq(document).ready(function(){
                setOnlyOfficeCookie("ulang","es")
            })
        }
